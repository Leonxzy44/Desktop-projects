...
start = int(input("Welcome to Lintorch! Make sure you have opened this in fullscreen! Here you browse projects or play games! Press ALT + F4 to leave or 1 + Enter to contine...   "))
...
if start == 1:
    ...
    user_output = input("Enter your username: ")

    

    print("Hi, ",user_output)
...
if source == "/cal":
    print(user_output,",", "Welcome to calculator!")
    time.sleep(0.5)
    ...
    print(user_output,",", "Welcome to Retify! This is an app for memory storing and taking notes.")
    time.sleep(0.5)
...
rate = input("Now, after using it, write a comment ---> ")
...
Note = input("Do you want to see the lastest news about Lintorch? (yes/no) : ")

if Note == "yes" or "Yes" : 
 
 print("Latest news: Lintorch 4.0 is coming out soon with a lot of new features and a new app features! Stay tuned!")

gt = input("Press 1 + Enter to continue...   ")

if gt == "1": 
 

 print("\033[92mLintorch is made by Leonxzy. For any technical issues or bugs, contact: leonhodzic44@gmail.com\033[0m")
